...
__global__ void proj_2f1c_block_range(
    ...
    // inv_depth
    unsigned int jacobian_3_col_start = idx_inv_depth;
    unsigned int jacobian_3_col_end = jacobian_3_col_start + 1;

    // cur_td
    unsigned int jacobian_4_col_start = 12;
    ...
    *(dev_ptr_set.hessian_03_row_start + idx_factor) = hessian_03_block_range.row_start;    // in Hpm
    *(dev_ptr_set.hessian_03_col_start + idx_factor) = hessian_03_block_range.col_start;    // in Hpm
    BlockRange hessian_04_block_range = GetJTJBlockRange(jacobian_0_block_range, jacobian_4_block_range);
    *(dev_ptr_set.hessian_04_row_start + idx_factor) = hessian_04_block_range.row_start;    // in Hpp
    *(dev_ptr_set.hessian_04_col_start + idx_factor) = hessian_04_block_range.col_start;    // in Hpp
    ...
    *(dev_ptr_set.hessian_13_row_start + idx_factor) = hessian_13_block_range.row_start;    // in Hpm
    *(dev_ptr_set.hessian_13_col_start + idx_factor) = hessian_13_block_range.col_start;    // in Hpm
    BlockRange hessian_14_block_range = GetJTJBlockRange(jacobian_1_block_range, jacobian_4_block_range);
    *(dev_ptr_set.hessian_14_row_start + idx_factor) = hessian_14_block_range.row_start;    // in Hpp
    *(dev_ptr_set.hessian_14_col_start + idx_factor) = hessian_14_block_range.col_start;    // in Hpp
    ...
    *(dev_ptr_set.hessian_23_row_start + idx_factor) = hessian_23_block_range.row_start;    // in Hpm
    *(dev_ptr_set.hessian_23_col_start + idx_factor) = hessian_23_block_range.col_start;    // in Hpm
    BlockRange hessian_24_block_range = GetJTJBlockRange(jacobian_2_block_range, jacobian_4_block_range);
    *(dev_ptr_set.hessian_24_row_start + idx_factor) = hessian_24_block_range.row_start;    // in Hpp
    *(dev_ptr_set.hessian_24_col_start + idx_factor) = hessian_24_block_range.col_start;    // in Hpp

    BlockRange hessian_30_block_range = GetJTJBlockRange(jacobian_3_block_range, jacobian_0_block_range);
    *(dev_ptr_set.hessian_30_row_start + idx_factor) = hessian_30_block_range.row_start;    // in Hmp
    *(dev_ptr_set.hessian_30_col_start + idx_factor) = hessian_30_block_range.col_start;    // in Hmp
    BlockRange hessian_31_block_range = GetJTJBlockRange(jacobian_3_block_range, jacobian_1_block_range);
    *(dev_ptr_set.hessian_31_row_start + idx_factor) = hessian_31_block_range.row_start;    // in Hmp
    *(dev_ptr_set.hessian_31_col_start + idx_factor) = hessian_31_block_range.col_start;    // in Hmp
    BlockRange hessian_32_block_range = GetJTJBlockRange(jacobian_3_block_range, jacobian_2_block_range);
    *(dev_ptr_set.hessian_32_row_start + idx_factor) = hessian_32_block_range.row_start;    // in Hmp
    *(dev_ptr_set.hessian_32_col_start + idx_factor) = hessian_32_block_range.col_start;    // in Hmp
    BlockRange hessian_33_block_range = GetJTJBlockRange(jacobian_3_block_range, jacobian_3_block_range);
    *(dev_ptr_set.hessian_33_row_start + idx_factor) = hessian_33_block_range.row_start;    // in Hmm
    *(dev_ptr_set.hessian_33_col_start + idx_factor) = hessian_33_block_range.col_start;    // in Hmm
    BlockRange hessian_34_block_range = GetJTJBlockRange(jacobian_3_block_range, jacobian_4_block_range);
    *(dev_ptr_set.hessian_34_row_start + idx_factor) = hessian_34_block_range.row_start;    // in Hmp
    *(dev_ptr_set.hessian_34_col_start + idx_factor) = hessian_34_block_range.col_start;    // in Hmp

    BlockRange hessian_40_block_range = GetJTJBlockRange(jacobian_4_block_range, jacobian_0_block_range);
    *(dev_ptr_set.hessian_40_row_start + idx_factor) = hessian_40_block_range.row_start;    // in Hpp
    *(dev_ptr_set.hessian_40_col_start + idx_factor) = hessian_40_block_range.col_start;    // in Hpp
    BlockRange hessian_41_block_range = GetJTJBlockRange(jacobian_4_block_range, jacobian_1_block_range);
    *(dev_ptr_set.hessian_41_row_start + idx_factor) = hessian_41_block_range.row_start;    // in Hpp
    *(dev_ptr_set.hessian_41_col_start + idx_factor) = hessian_41_block_range.col_start;    // in Hpp
    BlockRange hessian_42_block_range = GetJTJBlockRange(jacobian_4_block_range, jacobian_2_block_range);
    *(dev_ptr_set.hessian_42_row_start + idx_factor) = hessian_42_block_range.row_start;    // in Hpp
    *(dev_ptr_set.hessian_42_col_start + idx_factor) = hessian_42_block_range.col_start;    // in Hpp
    BlockRange hessian_43_block_range = GetJTJBlockRange(jacobian_4_block_range, jacobian_3_block_range);
    *(dev_ptr_set.hessian_43_row_start + idx_factor) = hessian_43_block_range.row_start;    // in Hpm
    *(dev_ptr_set.hessian_43_col_start + idx_factor) = hessian_43_block_range.col_start;    // in Hpm
    BlockRange hessian_44_block_range = GetJTJBlockRange(jacobian_4_block_range, jacobian_4_block_range);
    *(dev_ptr_set.hessian_44_row_start + idx_factor) = hessian_44_block_range.row_start;    // in Hpp
    *(dev_ptr_set.hessian_44_col_start + idx_factor) = hessian_44_block_range.col_start;    // in Hpp
    ...
    *(dev_ptr_set.rhs_3_row_start + idx_factor) = rhs_3_block_range.row_start;  // in Bmm
    BlockRange rhs_4_block_range{jacobian_4_col_start, jacobian_4_col_end, 0, 1};
    *(dev_ptr_set.rhs_4_row_start + idx_factor) = rhs_4_block_range.row_start;  // in Bpp
}
...
__global__ void proj_2f1c_temp(
    ...
    for(unsigned int i = 0; i < r.size(); i++) {
        *(dev_ptr_set.r_ex + i * num_proj_factors + idx_factor) = r(i);
    }
    for(unsigned int i = 0; i < p.size(); i++) {
        p(i) = *(dev_ptr_set.p_ex_0 + i * num_proj_factors + idx_factor);
    }
    pts = q * pts + p;  // pts_imu_i = q_ex * pts_cam_i + p_ex
    for(unsigned int i = 0; i < pts.size(); i++) {
        *(dev_ptr_set.pts_imu_i + i * num_proj_factors + idx_factor) = pts(i);
    }
    r_trans = r.transpose();
    for(unsigned int i = 0; i < r_trans.size(); i++) {
        *(dev_ptr_set.r_ex_trans + i * num_proj_factors + idx_factor) = r_trans(i);
    }
    ...
    pts = q.inverse() * (pts - p); // pts_cam_j = q_ex.inverse() * (pts_imu_j - p_ex)
    for(unsigned int i = 0; i < pts.size(); i++) {
    ...
    for(unsigned int i = 0; i < tmp_r_1.size(); i++) {
        tmp_r_1(i) = *(dev_ptr_set.r_ex_trans + i * num_proj_factors + idx_factor);
    }
    for(unsigned int i = 0; i < r.size(); i++) {
    ...
    for(unsigned int i = 0; i < r.size(); i++) {
        r(i) = *(dev_ptr_set.r_ex + i * num_proj_factors + idx_factor);
    }
...
__global__ void proj_2f1c_jacobian_1_r(     // q_j
    ...
    Eigen::Matrix<T, 3, 3, Eigen::RowMajor> r_ex_trans;
    for(unsigned int i = 0; i < r_ex_trans.size(); i++) {
        r_ex_trans(i) = *(dev_ptr_set.r_ex_trans + i * num_proj_factors + idx_factor);
    }
    ...
    Eigen::Matrix<T, 3, 3, Eigen::RowMajor> jacobian_1_r_tmp = r_ex_trans * UtilitySkewSymmetric<T>(pts_imu_j);
...
__global__ void proj_2f1c_jacobian_2_l(     // p_ex_0
    ...
    Eigen::Matrix<T, 3, 3, Eigen::RowMajor> r_j_trans;
    for(unsigned int i = 0; i < r_j_trans.size(); i++) {
        r_j_trans(i) = *(dev_ptr_set.r_j_trans + i * num_proj_factors + idx_factor);
    }
    ...
    Eigen::Matrix<T, 3, 3, Eigen::RowMajor> jacobian_2_l_tmp = r_ex_trans * (r_j_trans * r_i - Eigen::Matrix<T, 3, 3, Eigen::RowMajor>::Identity());
...
__global__ void proj_2f1c_jacobian_2_r(     // q_ex_0
    ...
    for(unsigned int i = 0; i < p_i.size(); i++) {
        p_i(i) = *(dev_ptr_set.p_i + i * num_proj_factors + idx_factor);
    }

    Eigen::Matrix<T, 3, 1> p_j;
    for(unsigned int i = 0; i < p_j.size(); i++) {
        p_j(i) = *(dev_ptr_set.p_j + i * num_proj_factors + idx_factor);
    }

    Eigen::Matrix<T, 3, 1> p_ex;
    for(unsigned int i = 0; i < p_ex.size(); i++) {
        p_ex(i) = *(dev_ptr_set.p_ex_0 + i * num_proj_factors + idx_factor);
    }
    ...
    Eigen::Matrix<T, 3, 3, Eigen::RowMajor> jacobian_2_r_tmp =  \
    - tmp_r_2 * UtilitySkewSymmetric<T>(pts_cam_i)              \
    + UtilitySkewSymmetric<T>(tmp_r_2 * pts_cam_i)              \
    + UtilitySkewSymmetric<T>(r_ex_trans * (r_j_trans * (r_i * p_ex + p_i - p_j) - p_ex));
...
__global__ void proj_2f1c_jacobian_3(       // inv_depth
    ...
    Eigen::Matrix<T, 3, 1> jacobian_3_tmp = tmp_r_2 * pts_i_td * -1.0 / pow(inv_depth_i, 2);
    Eigen::Matrix<T, 2, 1> jacobian_3 = reduce * jacobian_3_tmp;
...
__global__ void proj_2f1c_jacobian_4(       // cur_td
    ...
    Eigen::Matrix<T, 3, 1> jacobian_4_tmp = tmp_r_2 * velocity_i / inv_depth_i * -1.0;
    Eigen::Matrix<T, 2, 1> jacobian_4 = reduce * jacobian_4_tmp + velocity_j.head(2);
...
__global__ void proj_2f1c_hessian_00(   // pose_i, pose_i
    ...
    for(unsigned int i = 0; i < 4; i++) {
        robust_info[i / 2][i % 2] = __ldg(dev_ptr_set.robust_info + i * num_proj_factors + idx_factor); // *(dev_ptr_set.robust_info + i * num_proj_factors + idx_factor);
    }

    T jacobian_0[2][6];
    for(unsigned int i = 0; i < 12; i++) {
        jacobian_0[i / 6][i % 6] = __ldg(dev_ptr_set.jacobian_0 + i * num_proj_factors + idx_factor);  // *(dev_ptr_set.jacobian_0 + i * num_proj_factors + idx_factor);
    }
...
template __global__ void proj_2f1c_block_range<double>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<double> dev_ptr_set,
    bool marg
);

template __global__ void proj_2f1c_temp<double>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<double> dev_ptr_set,
    bool marg
);

template __global__ void proj_2f1c_jacobian_0_l<double>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<double> dev_ptr_set,
    bool marg
);

template __global__ void proj_2f1c_jacobian_0_r<double>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<double> dev_ptr_set,
    bool marg
);

template __global__ void proj_2f1c_jacobian_1_l<double>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<double> dev_ptr_set,
    bool marg
);

template __global__ void proj_2f1c_jacobian_1_r<double>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<double> dev_ptr_set,
    bool marg
);

template __global__ void proj_2f1c_jacobian_2_l<double>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<double> dev_ptr_set,
    bool marg
);

template __global__ void proj_2f1c_jacobian_2_r<double>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<double> dev_ptr_set,
    bool marg
);

template __global__ void proj_2f1c_jacobian_3<double>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<double> dev_ptr_set,
    bool marg
);

template __global__ void proj_2f1c_jacobian_4<double>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<double> dev_ptr_set,
    bool marg
);

template __global__ void proj_2f1c_residual<double>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<double> dev_ptr_set,
    bool marg
);

template __global__ void proj_2f1c_robust_info<double>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<double> dev_ptr_set,
    bool marg
);

template __global__ void proj_2f1c_rhs_0<double>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<double> dev_ptr_set,
    double* Bpp,
    bool marg
...
template __global__ void proj_2f1c_rhs_1<double>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<double> dev_ptr_set,
    double* Bpp,
    bool marg
...
template __global__ void proj_2f1c_rhs_2<double>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<double> dev_ptr_set,
    double* Bpp,
    bool marg
...
template __global__ void proj_2f1c_rhs_3<double>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<double> dev_ptr_set,
    double* Bmm,
    bool marg
...
template __global__ void proj_2f1c_rhs_4<double>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<double> dev_ptr_set,
    double* Bpp,
    bool marg
...
template __global__ void proj_2f1c_hessian_00<double>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<double> dev_ptr_set,
    double* Hpp,
    int leading_dim_Hpp,
...
template __global__ void proj_2f1c_hessian_01<double>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<double> dev_ptr_set,
    double* Hpp,
    int leading_dim_Hpp,
...
template __global__ void proj_2f1c_hessian_02<double>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<double> dev_ptr_set,
    double* Hpp,
    int leading_dim_Hpp,
...
template __global__ void proj_2f1c_hessian_03<double>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<double> dev_ptr_set,
    double* Hpm,
    int leading_dim_Hpm,
...
template __global__ void proj_2f1c_hessian_04<double>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<double> dev_ptr_set,
    double* Hpp,
    int leading_dim_Hpp,
...
template __global__ void proj_2f1c_hessian_11<double>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<double> dev_ptr_set,
    double* Hpp,
    int leading_dim_Hpp,
...
template __global__ void proj_2f1c_hessian_12<double>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<double> dev_ptr_set,
    double* Hpp,
    int leading_dim_Hpp,
...
template __global__ void proj_2f1c_hessian_13<double>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<double> dev_ptr_set,
    double* Hpm,
    int leading_dim_Hpm,
...
template __global__ void proj_2f1c_hessian_14<double>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<double> dev_ptr_set,
    double* Hpp,
    int leading_dim_Hpp,
...
template __global__ void proj_2f1c_hessian_22<double>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<double> dev_ptr_set,
    double* Hpp,
    int leading_dim_Hpp,
...
template __global__ void proj_2f1c_hessian_23<double>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<double> dev_ptr_set,
    double* Hpm,
    int leading_dim_Hpm,
...
template __global__ void proj_2f1c_hessian_24<double>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<double> dev_ptr_set,
    double* Hpp,
    int leading_dim_Hpp,
...
template __global__ void proj_2f1c_hessian_33<double>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<double> dev_ptr_set,
    double* Hmm_diag,
    bool marg
...
template __global__ void proj_2f1c_hessian_34<double>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<double> dev_ptr_set,
    double* Hpm,
    int leading_dim_Hpm,
...
template __global__ void proj_2f1c_hessian_44<double>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<double> dev_ptr_set,
    double* Hpp,
    int leading_dim_Hpp,
...
template __global__ void proj_2f1c_block_range<float>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<float> dev_ptr_set,
    bool marg
);

template __global__ void proj_2f1c_temp<float>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<float> dev_ptr_set,
    bool marg
);

template __global__ void proj_2f1c_jacobian_0_l<float>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<float> dev_ptr_set,
    bool marg
);

template __global__ void proj_2f1c_jacobian_0_r<float>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<float> dev_ptr_set,
    bool marg
);

template __global__ void proj_2f1c_jacobian_1_l<float>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<float> dev_ptr_set,
    bool marg
);

template __global__ void proj_2f1c_jacobian_1_r<float>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<float> dev_ptr_set,
    bool marg
);

template __global__ void proj_2f1c_jacobian_2_l<float>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<float> dev_ptr_set,
    bool marg
);

template __global__ void proj_2f1c_jacobian_2_r<float>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<float> dev_ptr_set,
    bool marg
);

template __global__ void proj_2f1c_jacobian_3<float>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<float> dev_ptr_set,
    bool marg
);

template __global__ void proj_2f1c_jacobian_4<float>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<float> dev_ptr_set,
    bool marg
);

template __global__ void proj_2f1c_residual<float>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<float> dev_ptr_set,
    bool marg
);

template __global__ void proj_2f1c_robust_info<float>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<float> dev_ptr_set,
    bool marg
);

template __global__ void proj_2f1c_rhs_0<float>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<float> dev_ptr_set,
    float* Bpp,
    bool marg
...
template __global__ void proj_2f1c_rhs_1<float>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<float> dev_ptr_set,
    float* Bpp,
    bool marg
...
template __global__ void proj_2f1c_rhs_2<float>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<float> dev_ptr_set,
    float* Bpp,
    bool marg
...
template __global__ void proj_2f1c_rhs_3<float>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<float> dev_ptr_set,
    float* Bmm,
    bool marg
...
template __global__ void proj_2f1c_rhs_4<float>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<float> dev_ptr_set,
    float* Bpp,
    bool marg
...
template __global__ void proj_2f1c_hessian_00<float>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<float> dev_ptr_set,
    float* Hpp,
    int leading_dim_Hpp,
...
template __global__ void proj_2f1c_hessian_01<float>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<float> dev_ptr_set,
    float* Hpp,
    int leading_dim_Hpp,
...
template __global__ void proj_2f1c_hessian_02<float>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<float> dev_ptr_set,
    float* Hpp,
    int leading_dim_Hpp,
...
template __global__ void proj_2f1c_hessian_03<float>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<float> dev_ptr_set,
    float* Hpm,
    int leading_dim_Hpm,
...
template __global__ void proj_2f1c_hessian_04<float>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<float> dev_ptr_set,
    float* Hpp,
    int leading_dim_Hpp,
...
template __global__ void proj_2f1c_hessian_11<float>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<float> dev_ptr_set,
    float* Hpp,
    int leading_dim_Hpp,
...
template __global__ void proj_2f1c_hessian_12<float>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<float> dev_ptr_set,
    float* Hpp,
    int leading_dim_Hpp,
...
template __global__ void proj_2f1c_hessian_13<float>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<float> dev_ptr_set,
    float* Hpm,
    int leading_dim_Hpm,
...
template __global__ void proj_2f1c_hessian_14<float>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<float> dev_ptr_set,
    float* Hpp,
    int leading_dim_Hpp,
...
template __global__ void proj_2f1c_hessian_22<float>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<float> dev_ptr_set,
    float* Hpp,
    int leading_dim_Hpp,
...
template __global__ void proj_2f1c_hessian_23<float>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<float> dev_ptr_set,
    float* Hpm,
    int leading_dim_Hpm,
...
template __global__ void proj_2f1c_hessian_24<float>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<float> dev_ptr_set,
    float* Hpp,
    int leading_dim_Hpp,
...
template __global__ void proj_2f1c_hessian_33<float>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<float> dev_ptr_set,
    float* Hmm_diag,
    bool marg
...
template __global__ void proj_2f1c_hessian_34<float>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<float> dev_ptr_set,
    float* Hpm,
    int leading_dim_Hpm,
...
template __global__ void proj_2f1c_hessian_44<float>(
    int num_proj_factors,
    Proj2F1CFactorDevPtrSet<float> dev_ptr_set,
    float* Hpp,
    int leading_dim_Hpp,
